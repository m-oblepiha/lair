...
const PetScreenStat: React.FC<StatProps> = ({ src, value, reverse }) => {
  ...
  return (
    ...
    >
      ...
      <div className={classes.stats}>
        ...
        <PetScreenStat src={hunger} value={pet.stats.hunger} reverse />
        <PetScreenStat src={fatigue} value={pet.stats.fatigue} reverse />
      </div>
    </li>
  );
};
